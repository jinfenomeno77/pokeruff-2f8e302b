...
## 3. Indicador de carregamento dentro do popup Enquanto a busca de inscritos estiver em andamento (entre abrir o popup e a lista chegar), mostrar uma mensagem simples tipo "Carregando inscritos..." no lugar onde a lista de participantes aparece — em vez de deixar a área vazia sem nenhuma indicação. Isso precisa de um novo estado, por exemplo um "loadingRegistrations" (setado como true no início de openTournament, junto com a limpeza do setRegistrations([]), e false quando a busca terminar).